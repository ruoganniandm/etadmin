...
import com.eternity.modules.system.service.MonitorService;
import com.eternity.utils.EtAdminConstant;
...
public class MonitorServiceImpl implements MonitorService {
    ...
    private Map<String,Object> getDiskInfo(OperatingSystem os) {
        ...
        for (OSFileStore fs : fsArray){
            ...
            if(osName.toLowerCase().startsWith(EtAdminConstant.WIN)) {
