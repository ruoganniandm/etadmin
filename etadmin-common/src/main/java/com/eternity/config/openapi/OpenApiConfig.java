 ...
 */
package com.eternity.config.openapi;
...
public class OpenApiConfig {
    ...
    public OpenAPI springDocOpenAPI() {
        ...
        // 接口调试路径
        Server tryServer = new Server().url(swaggerProperties.getTryHost());
        Contact contact = new Contact().name("eternity").url("https://www.baidu.com").email("xxx@mail.com");
...
//                .addParameters("SpInfo", new HeaderParameter().name("platform").description("平台信息（标识）").schema(new StringSchema()).required(false));
    ...
    private List<SecurityRequirement> securityRequirements() {
        ...
        SecurityRequirement authHeader = new SecurityRequirement().addList(tokenHeader);
